...
train_X_2 = train_df.drop(['index', 'id', 'timestamp', 'price_doc', 'ppa', 'full_sq', 'life_sq', 'kitch_sq'], axis=1)
test_X_2 = test_df.drop(['id', 'timestamp', 'full_sq', 'life_sq', 'kitch_sq'], axis=1)
